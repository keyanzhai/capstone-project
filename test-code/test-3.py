    ...
    while cap.isOpened():
        ...
        if 'landmark' in dir(results.pose_world_landmarks):
            ...
            if (frame >= 30):
                ...
                # Dynamic Thresholding based on distance and visibility
                # TODO: Update values with image width * percentage = 25 or 20
                # 25 = 0.013 * image_width
                # 20 = 0.010 * image_width
                threshold = np.array([[25],[25],[20],[25],[25],[20]]) + (1 - visibility) * 25
